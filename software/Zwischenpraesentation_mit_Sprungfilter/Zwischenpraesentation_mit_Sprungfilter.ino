...
PID hoehePID(&istH, &geschwindigkeitH, &sprungH, 5, 0.6, 13, DIRECT);    //funktioniert ganz gut in Kombination mit Schranken für Motorleistung

//PID-Regler für Richtungsregelung
PID richtungsPID(&yaw, &geschwindigkeit_r, &sollPhi, 5, 0.6, 13, DIRECT);
  ...
  if (handler == 0) {
   ...
   //     sprungH=100;}
    ...
    if(geschwindigkeit_r > 0) {
      ...
      motor(motor_R, 1, 0-geschwindigkeit_r);
