...
PID richtungsPID(&yaw, &geschwindigkeit_r, &sollPhi, 5, 0.6, 13, DIRECT);    //absolute Ausrichtung nach Nordpolwinkel funktioniert sehr gut!!
...
void Periode() {
  if (handler == 0) {
    ...
    if(geschwindigkeit_r > 0) {
      ...
      motor(motor_L, 0, 0-geschwindigkeit_r+10);
    }
  }
}
