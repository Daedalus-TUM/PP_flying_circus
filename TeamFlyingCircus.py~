...
class TeamFlyingCircus(threading.Thread):
    ...
    def onNewPos(self):
        ...
        if (self.main.doppel%2==0):
          ...
          buf0 = self.main.waypoints[currentWP][0] - self.main.filterdPos[0]
          buf1 = self.main.waypoints[currentWP][1] - self.main.filterdPos[1]
        ...
        if ((local_x*local_x+local_y*local_y) < 1000)
